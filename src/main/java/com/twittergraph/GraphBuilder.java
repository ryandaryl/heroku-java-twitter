...
public class GraphBuilder {
    ...
    public String toGEXF() {
        ...
        Exporter exporterGraphGEXF = ec.getExporter("gexf");
        exporterGraphGEXF.setWorkspace(workspace);
        StringWriter stringWriter = new StringWriter();
        ec.exportWriter(stringWriter, (CharacterExporter) exporterGraphGEXF);
